...
export const SERVICES: Service[] = [
  {
    ...
    body: "We build production-ready web applications with responsive interfaces, secure APIs, role-based access, real-time features, and scalable application architecture.",
  ...
  },
  {
    ...
    body: "We develop cross-platform mobile products with reliable navigation, API integration, authentication, notifications, device capabilities, and polished user experiences.",
  ...
  },
  {
    ...
    body: "We turn product requirements into clear user flows, responsive interfaces, interactive prototypes, and scalable design systems that developers can implement accurately.",
  ...
  },
  {
    ...
    body: "We create business-focused desktop software for workflows that require local processing, structured data, integrations, automation, and dependable day-to-day performance.",
    tags: ["Python", "Electron", "APIs", "Automation"],
    icon: IconDesktop,
  ...
  },
  {
    ...
    body: "We build practical AI systems using LLMs, retrieval pipelines, tool calling, agentic workflows, and business data to create assistants that can reason, retrieve, and act.",
    tags: ["LLMs", "RAG", "LangChain", "LangGraph", "OpenAI"],
    icon: IconChat,
  ...
  },
  {
    ...
    body: "We automate repetitive workflows and build resilient data extraction systems with browser automation, job queues, retries, scheduling, and structured output pipelines.",
  ...
  },
  {
    ...
    title: "Email & Campaign Platforms",
    body: "We build campaign tools that manage contacts, segmentation, personalized messaging, delivery workflows, and performance analytics through reliable communication infrastructure.",
    tags: ["Node.js", "SendGrid", "Segmentation", "Analytics"],
    icon: IconMail,
    tone: "from-cyan-500/25 to-blue-600/10 text-cyan-300 border-cyan-400/20 hover:border-cyan-300/45",
  },
  {
    slug: "form-services",
    title: "Form & Workflow Services",
    body: "We engineer reliable submission pipelines with validation, webhooks, asynchronous processing, queues, integrations, and monitoring for high-volume business workflows.",
    tags: ["Node.js", "Webhooks", "Queues", "APIs"],
    icon: IconRobot,
